...
.choose-list li, .choosed-list li {
	overflow: hidden;
	padding: 10px 0px;
}
...
.choose-list span+span {
	display: inline-block;
	width: 1000%;
}

.choosed-list span+span {
	width: 100%;
}
</style>
	...
	<div class="main_content add_block">
		<div class='div_bordered'>
			<div class="panel panel-default choose_block">
				<a href="planlist.action" class="colorbg font14 pull-right mr15">&lt;&lt;返回列表</a>
				...
				<form class="form-horizontal old_block"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text"
								class="form-control input200 validate[required,custom[illegallyStr],maxSize[32]]"
								id="plan_name" name="plan_name" placeholder="请输入排班方案名称" value="" />
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea onkeyup="textareaLeftWords(this)" style="width: 30%"
								class="form-control validate[custom[illegallyStr],maxSize[160]]"
								rows="2" name="plan_description" id="plan_description"></textarea>
							<em id="tLeftWord" left-word="160">还可以输入<span
								class="color333">160</span>字
							</em>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<button type="button" class="btn btn_white20"
								onclick="getDemo1()" id="demo1">三班倒</button>
							&nbsp;&nbsp;
							<button type="button" class="btn btn_white20"
								onclick="getDemo2()" id="demo2">两班倒</button>
						</div>
					</div>
					...
					<div class="col-sm-5">
						<div class="pull-right text-right mr15 so-awesome2">
							<button type="button" class="btn_white site_add"
								onclick="addItem()" style="margin-top: 0px;">
								<i></i>继续添加
							</button>
						</div>
							...
							<tbody id="myTbody">
								<tr class="shift_tr" id="1_tr">
									...
									<td><input type="text" class="form-control input80 "
										...
										placeholder="连续天数" /></td>
									<td><span><a href="javascript:goUp('1')"
				...
				<div class="form-group mb0 text-center" style='clear: both'>
					...
					<div class="text-align:left;" id="setjoyRide">
						<button type="button" class="btn btn_green" onclick="saveIt()"id="plan_add">
							<a href="/files/planadd.action">增加</a>
						</button>
						<button type="button" class="btn btn_whites" onclick="cancelIt()"
							id="plan_exit">取消</button>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	...
	function getDemo1() {
		...
		var demo1 = '<tr class="shift_tr" id="1_tr">'
				+ '<td><input type="text" class="form-control input100" name="detail_name" onblur="validateName(this.value,this)" value="中" placeholder="班次名称"></td>'
				+ '<td><input type="text" class="form-control input100 selcTime" name="start_time" value="8:00" onblur="validateTime(this.value,this)" placeholder="开始时间"></td>'
				+ '<td><input type="text" class="form-control input100 selcTime" name="end_time" value="16:00" onblur="validateTime(this.value,this)" placeholder="结束时间"></td>'
				...
				+ '<input type="hidden" id="exc_order" class="form-control input100" name="exc_order" value="1">'
				+ '</td>'
				+ '<td><i class="delete_icon" style="margin-left:5px;" onclick="removeItem(this,\'1\')"></i></td>'
				+ '</tr>'
				+ '<tr class="shift_tr" id="2_tr">'
				+ '<td><input type="text" class="form-control input100" name="detail_name" onblur="validateName(this.value,this)" value="早" placeholder="班次名称"></td>'
				+ '<td><input type="text" class="form-control input100 selcTime" name="start_time" value="0:00" onblur="validateTime(this.value,this)" placeholder="开始时间"></td>'
				+ '<td><input type="text" class="form-control input100 selcTime" name="end_time" value="8:00" onblur="validateTime(this.value,this)" placeholder="结束时间"></td>'
				+ '<td><input type="text" class="form-control input100 " name="days" onblur="validateDays(this.value,this)" value="2" placeholder="连续天数"></td>'
				+ '<td>'
				+ '<span><a href="javascript:goUp(\'2\')" class="colorblue">上移</a></span>'
				+ '<span><a href="javascript:goDown(\'2\')" class="colorblue">下移</a></span>'
				+ '<input type="hidden" id="exc_order" class="form-control input100" name="exc_order" value="2">'
				+ '</td>'
				+ '<td><i class="delete_icon" style="margin-left:5px;" onclick="removeItem(this,\'2\')"></i></td>'
				+ '</tr>'
				+ '<tr class="shift_tr" id="3_tr">'
				+ '<td><input type="text" class="form-control input100" name="detail_name" onblur="validateName(this.value,this)" value="晚" placeholder="班次名称"></td>'
				+ '<td><input type="text" class="form-control input100 selcTime" name="start_time" value="16:00" onblur="validateTime(this.value,this)" placeholder="开始时间"></td>'
				+ '<td><input type="text" class="form-control input100 selcTime" name="end_time" value="0:00" onblur="validateTime(this.value,this)" placeholder="结束时间"></td>'
				+ '<td><input type="text" class="form-control input100 " name="days" onblur="validateDays(this.value,this)" value="2" placeholder="连续天数"></td>'
				+ '<td>'
				+ '<span><a href="javascript:goUp(\'3\')" class="colorblue">上移</a></span>'
				+ '<span><a href="javascript:goDown(\'3\')" class="colorblue">下移</a></span>'
				+ '<input type="hidden" id="exc_order" class="form-control input100" name="exc_order" value="3">'
				+ '</td>'
				+ '<td><i class="delete_icon" style="margin-left:5px;" onclick="removeItem(this,\'3\')"></i></td>'
				+ '</tr>'
				+ '<tr class="shift_tr" id="4_tr">'
				+ '<td>休<input type="hidden" name="detail_name" value="休"></td>'
				+ '<td><input type="hidden" name="start_time" value=" "></td>'
				+ '<td><input type="hidden" name="end_time" value=" "></td>'
				+ '<td><input type="text" class="form-control input100 " name="days" onblur="validateDays(this.value,this)" value="2" placeholder="连续天数"></td>'
				+ '<td>'
				+ '<span><a href="javascript:goUp(\'4\')" class="colorblue">上移</a></span>'
				+ '<span><a href="javascript:goDown(\'4\')" class="colorblue">下移</a></span>'
				+ '<input type="hidden" id="exc_order" class="form-control input100" name="exc_order" value="4" placeholder="执行顺序">'
				+ '</td>' + '<td></td>' + '</tr>';
	...
	function getDemo2() {
		...
		var demo2 = '<tr class="shift_tr" id="1_tr">'
				+ '<td><input type="text" class="form-control input100" name="detail_name" onblur="validateName(this.value,this)" value="早" placeholder="班次名称"></td>'
				+ '<td><input type="text" class="form-control input100 selcTime" name="start_time" value="08:00" onblur="validateTime(this.value,this)" placeholder="开始时间"></td>'
				+ '<td><input type="text" class="form-control input100 selcTime" name="end_time" value="20:00" onblur="validateTime(this.value,this)" placeholder="结束时间"></td>'
				+ '<td><input type="text" class="form-control input100 " name="days" onblur="validateDays(this.value,this)" value="2" placeholder="连续天数"></td>'
				+ '<td>'
				+ '<span><a href="javascript:goUp(\'1\')" class="colorblue">上移</a></span>'
				+ '<span><a href="javascript:goDown(\'1\')" class="colorblue">下移</a></span>'
				...
				+ '<tr class="shift_tr" id="2_tr">'
				+ '<td><input type="text" class="form-control input100" name="detail_name" onblur="validateName(this.value,this)" value="晚" placeholder="班次名称"></td>'
				+ '<td><input type="text" class="form-control input100 selcTime" name="start_time" value="20:00" onblur="validateTime(this.value,this)" placeholder="开始时间"></td>'
				+ '<td><input type="text" class="form-control input100 selcTime" name="end_time" value="08:00" onblur="validateTime(this.value,this)" placeholder="结束时间"></td>'
				+ '<td><input type="text" class="form-control input100 " name="days" onblur="validateDays(this.value,this)" value="2" placeholder="连续天数"></td>'
				+ '<td>'
				+ '<span><a href="javascript:goUp(\'2\')" class="colorblue">上移</a></span>'
				+ '<span><a href="javascript:goDown(\'2\')" class="colorblue">下移</a></span>'
				...
				+ '<span><a href="javascript:goUp(\'3\')" class="colorblue">上移</a></span>'
				+ '<span><a href="javascript:goDown(\'3\')" class="colorblue">下移</a></span>'
				+ '<input type="hidden" id="exc_order" class="form-control input100" name="exc_order" value="3" placeholder="执行顺序">'
				+ '</td>' + '<td></td>' + '</tr>'
