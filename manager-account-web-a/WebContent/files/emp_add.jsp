...
<body>
	...
	<div class="main_content create_site">
		<div class="col-xs-12 col-sm-12 div_bordered ">
			...
			<form action="<%=EMP_ADD_URL%>" method="post" class="form-horizontal"
				id="empsForm" enctype="multipart/form-data">
				<div class="panel-body ">
					<div class="well_head mt0">
						<div class="line"></div>
						<span class="pull-left" href="javascript:void(0);"><b
							class="color66">员工增加</b></span>
					</div>
					<div class="panel-body">
						<table class="zhy_book_table">
							<tr>
								...
								<td align="left" width="40%"><input type="text"
									class="form-control inline input150" id="name" name="name"
									placeholder="请输入员工姓名" /> <!-- <button type="button" class="btn btn_save2" onclick="showPopC('mem_choose')" style="width: auto;padding: 0px 5px;">选择</button> -->
								</td>
							...
							<td align="left">
								...
								<td align="left"><input type="text"
									class="form-control inline input200" id="id_card"
									name="id_card" placeholder="请输入身份证号" /></td>
							</tr>
							<tr>
								<td align="right">手机号：</td>
								<td align="left"><input type="text"
									class="form-control inline input150" id="phone" name="phone"
									placeholder="请输入手机号" /></td>
							</tr>
							<tr>
								<td align="right" width="120">email：</td>
								<td align="left" width="40%"><input type="text"
									class="form-control inline input150" id="email" name="email"
									placeholder="请输入邮箱" /> <!-- <button type="button" class="btn btn_save2" onclick="showPopC('mem_choose')" style="width: auto;padding: 0px 5px;">选择</button> -->
								</td>
								<td align="right" width="160"></td>
								<td align="right" width="60%"></td>
							</tr>
...
<script type="text/javascript">
	...
	var picker_S = new Pikaday({
		...
		onSelect : function() {
			...
			var year = MaxDate.getFullYear(), month = MaxDate.getMonth() + 1;
			var days;
			//当月份为二月时，根据闰年还是非闰年判断天数
			if (month == 2) {
				days = year % 4 == 0 ? 29 : 28;
