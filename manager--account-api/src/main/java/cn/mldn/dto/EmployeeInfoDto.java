...
public class EmployeeInfoDto implements Serializable{
	...
	public String toString() {
		return "EmployeeInfoDto [eid=" + eid + ", name=" + name + ", avatar=" + avatar + ", sex="
				+ sex + ", phone=" + phone + ", id_card=" + id_card + ", birthday=" + birthday
				+ ", hire_date=" + hire_date + ", dimission_date=" + dimission_date
				+ ", education_degree=" + education_degree + ", create_id=" + create_id
				+ ", last_update_user_id=" + last_update_user_id + ", create_time=" + create_time
				+ ", update_time=" + update_time + ", team_id=" + team_id + ", last_update_no="
				+ last_update_no + ", state=" + state + ", email=" + email + "]";
	}
